 pipeline {
  ...
  stages {
    ...
    stage('TF Apply') {
      steps {
          sh """
          export TF_VAR_okta_user_first_name=${params.}
          export TF_VAR_okta_user_last_name=${params.}
          export TF_VAR_okta_user_login=${params.}
          export TF_VAR_okta_user_email=${params.}
          export TF_VAR_okta_group_name=${params.groupname}
          export TF_VAR_group_description=${params.description}
          export TF_VAR_okta_auth_server_name=${params.}
          export TF_VAR_okta_auth_server_description=${params.}
          export TF_VAR_okta_app_saml_label=${params.}
          export TF_VAR_okta_inline_hook_name=${params.}
          export TF_VAR_okta_idp_social_name=${params.}
